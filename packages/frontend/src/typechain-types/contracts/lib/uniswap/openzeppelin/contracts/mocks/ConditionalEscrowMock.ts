...
export interface ConditionalEscrowMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deposit"
      | "depositsOf"
...
export interface ConditionalEscrowMock extends BaseContract {
  connect(runner?: ContractRunner | null): ConditionalEscrowMock;
  ...
  setAllowed: TypedContractMethod<
    [payee: AddressLike, allowed: boolean],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[payee: AddressLike], [boolean], "view">;
