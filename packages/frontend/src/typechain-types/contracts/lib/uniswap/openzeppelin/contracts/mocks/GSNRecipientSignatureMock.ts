...
export interface GSNRecipientSignatureMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptRelayedCall"
      | "getHubAddr"
...
export interface GSNRecipientSignatureMock extends BaseContract {
  connect(runner?: ContractRunner | null): GSNRecipientSignatureMock;
  waitForDeployment(): Promise<this>;

  interface: GSNRecipientSignatureMockInterface;
