...
export interface ERC777MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC777Mock extends BaseContract {
  connect(runner?: ContractRunner | null): ERC777Mock;
  ...
  approveInternal: TypedContractMethod<
    [holder: AddressLike, spender: AddressLike, value: BigNumberish],
    [void],
    "nonpayable"
  >;
