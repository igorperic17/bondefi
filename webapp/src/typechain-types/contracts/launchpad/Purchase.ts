...
export interface PurchaseInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "lastPurchaseId",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "purchaseBalances",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Purchase extends BaseContract {
  ...
  refund: TypedContractMethod<[tokenId: BigNumberish], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "lastPurchaseId"
