...
import { LucideBitcoin, LucideCoins, LucideDollarSign, LucideEuro, LucideHandCoins, LucideLandmark, LucideUser } from "lucide-react";
        ...
        >
            <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div1Ref}>
                        <LucideCoins color="black" />
                    </Circle>
                    <Circle ref={div5Ref}>
                        <LucideLandmark color="black" />
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div2Ref}>
                        <LucideBitcoin color="black" />
                    </Circle>
                    <Circle ref={div4Ref} className="size-16">
                        <LucideUser color="black" />
                    </Circle>
                    <Circle ref={div6Ref}>
                        <LucideDollarSign color="black" />
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div3Ref}>
                        <LucideEuro color="black" />
                    </Circle>
                    <Circle ref={div7Ref}>
                        <LucideHandCoins color="black" />
                    </Circle>
                </div>
            </div>
